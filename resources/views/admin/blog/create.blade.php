        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{route('admin.blog.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group py-3 mt-3">
                        <label for="ckeditor">Konten</label>
                        <textarea class="form-control @error('konten') is-invalid @enderror" id="ckeditor" name="konten">{{old('konten')}}</textarea>
                    ...
                    <button type="submit" class="btn btn-primary d-block">Tambah Artikel</button>
                </form>
            </div>
        </div>
    </div>
